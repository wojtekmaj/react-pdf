...
- [v10.x](https://github.com/wojtekmaj/react-pdf/blob/v10.x/packages/react-pdf/README.md)
...
Wrap `Document` in the Error Boundary so resetting it retries the entire load. To reload a mounted document, change its React `key`. See the [test page](https://github.com/wojtekmaj/react-pdf/blob/main/test/Test.tsx) for an example.
...
| error              | What the component should display in case of an error when `suspense={false}`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `"Failed to load PDF file."`                          | <ul><li>String:<br />`"An error occurred!"`</li><li>React element:<br />`<p>An error occurred!</p>`</li><li>Function:<br />`this.renderError`</li></ul>                                                                                                                      |
...
| file               | What PDF should be displayed.<br />Its value can be an URL, a file (imported using `import … from …` or from file input form element), or an object with parameters (`url` - URL; `data` - data, preferably Uint8Array; `range` - PDFDataRangeTransport.<br />Suspense compares plain parameter objects by value. Keep binary inputs and range transports outside the suspended subtree. With `suspense={false}`, memoize object props to avoid unnecessary reloads.                                                                                                                                                                                     | n/a                                                   | <ul><li>URL:<br />`"https://example.com/sample.pdf"`</li><li>File:<br />`import importedPdf from '../static/sample.pdf'` and then<br />`sample`</li><li>Parameter object:<br />`{ url: 'https://example.com/sample.pdf' }`</ul>                                              |
...
| loading            | What the component should display while loading when `suspense={false}`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `"Loading PDF…"`                                      | <ul><li>String:<br />`"Please wait!"`</li><li>React element:<br />`<p>Please wait!</p>`</li><li>Function:<br />`this.renderLoader`</li></ul>                                                                                                                               |
...
| suspense | Use React Suspense and Error Boundaries for loading and failures. Children inherit the document setting and can override it. | `true` | `false` |
...
| customTextRenderer             | Function that customizes how a text layer is rendered. React-PDF applies best-effort filtering to the returned HTML, but you are responsible for ensuring that it is safe and properly sanitized.                                                                                                   | n/a                                                 | ``({ str, itemIndex }) => str.replace(/ipsum/g, value => `<mark>${value}</mark>`)``                                                                                                                                                                                        |
...
| error                          | What the component should display in case of an error when `suspense={false}`.                                                                                                                                                                                                                                           | `"Failed to load the page."`                        | <ul><li>String:<br />`"An error occurred!"`</li><li>React element:<br />`<p>An error occurred!</p>`</li><li>Function:<br />`this.renderError`</li></ul>                                                                                                                    |
...
| loading                        | What the component should display while loading when `suspense={false}`.                                                                                                                                                                                                                                                 | `"Loading page…"`                                   | <ul><li>String:<br />`"Please wait!"`</li><li>React element:<br />`<p>Please wait!</p>`</li><li>Function:<br />`this.renderLoader`</li></ul>                                                                                                                               |
...
| suspense | Use React Suspense and Error Boundaries for loading and failures. Children inherit the document setting and can override it. | `true` (or inherited) | `false` |
...
| suspense | Use React Suspense and Error Boundaries. Inherits the document setting. | `true` (or inherited) | `false` |
