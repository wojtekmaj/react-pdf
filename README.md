...
|Prop name|Description|Default value|Example values|
|----|----|----|----|
|canvasBackground|Custom canvas background value. Any valid `canvas.fillStyle` can be used. If you set `renderMode` to `"svg"` this prop will be ignored.|n/a|`"transparent"`|
