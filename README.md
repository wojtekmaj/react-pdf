...
- Import the styles for [annotations](https://github.com/wojtekmaj/react-pdf#support-for-annotations) and [text layer](https://github.com/wojtekmaj/react-pdf#support-for-text-layer) if applicable.
