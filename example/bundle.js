  ...
  render: function() {
    return (
      React.DOM.div({className: "container"}, 
        React.DOM.h1(null, "PDF.js + React = <3"), 
        PDF({page: this.state.currentPage, file: "example.pdf"}), 
        React.DOM.div(null, 
          React.DOM.button({onClick: this.prevPage}, "Previous page"), 
          React.DOM.button({onClick: this.nextPage}, "Next page")
        )
      )
    );
  }
...
},{"../":2,"react":147}],2:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
...
var Pdf = React.createClass({displayName: 'Pdf',
  getInitialState: function() {
    return {};
  },
  ...
  render: function() {
    ...
    return this.state.pdfPage ? React.DOM.canvas(null) : React.DOM.div(null, "Loading pdf..");
  }
});
...
},{"react":147}],3:[function(require,module,exports){
