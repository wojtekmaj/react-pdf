  ...
  (0, _createClass2.default)(TextLayerItemInternal, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return page.commonObjs.ensureObj(fontName);
    ...
    value: function () {
      ...
      _regenerator.default.mark(function _callee2() {
        var element, _this$props, fontName, scale, width, fontData, fallbackFontName, targetWidth, actualWidth, ascent;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                ...
                element.style.transform = "scaleX(".concat(targetWidth / actualWidth, ") translateY(").concat((1 - ascent) * 100, "%)");
